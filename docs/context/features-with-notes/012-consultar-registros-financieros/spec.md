...
- **RF-004**: El sistema DEBE recuperar, dentro del alcance correspondiente al solicitante (propietario asociado igual al solicitante, o histórico global para el Administrador Financiero), los registros de cobro (definidos en "Procesar cobro"), reembolso (definidos en "Reembolsar dinero a arrendatario") y dispersión (definidos en "Dispersar fondos de alquiler").
